    ...
    >
      ...
      <div className="relative z-10 max-w-3xl px-4 text-center space-y-6">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="#products"
            className="px-6 py-3 rounded-full bg-yellow-500 hover:bg-yellow-400 text-sm md:text-base font-medium transition"
          >
            Shop featured products
          </a>
          <a
            href="#shop-by"
            className="px-6 py-3 rounded-full border border-slate-500 hover:border-yellow-400 text-sm md:text-base font-medium transition"
          >
            Explore by category
          </a>
        </div>
