...
export function ArrowChip({ size = "sm" }: ArrowChipProps) {
  ...
  return (
    <div className={`${dim} flex items-center justify-center rounded-xl bg-white/5 border border-white/10 group-hover:bg-emerald-500 group-hover:border-emerald-500 transition-all duration-300`}>
